...
String.prototype.substituteVars = function () {
 ...
 // GLOBAL objects
 {
	...
	Global.SCRIPT_URL         = 'https://cuneytyilmaz.com/progs/CuMediaExtenders4DirectoryOpus/';
...
var config = (function () {
	...
	return {
		...
		getKeys: function () {
			var keys = [];
			for (k in _vals) if (_vals.hasOwnProperty(k)) keys.push(k);
			return keys;
		},
		/**
		 * @param {string} key config key
...
// CONFIG - DEFAULT VALUES
{
	...
	var lookup_codecs_long = function(){return{
		// This is just the help variable for your reference
		// (this is not valid JSON but makes it possible for me to show you more info)
		//
		// When you edit the real variable, just make sure it is valid JSON:
		...
		"AVC-AVC1-X264"                                          : "H264 (x264)",
		"AVC-H264-X264"                                          : "H264 (x264)",
		"AVC-V_MPEG4/ISO/AVC-X264"                               : "H264 (x264)",
		"AVC-X264"                                               : "H264 (x264)",
		// same as above without the extras, the one which comes later takes precedence
		// "AVC-AVC1-X264"                                          : "H264",
		// "AVC-H264-X264"                                          : "H264",
		// "AVC-V_MPEG4/ISO/AVC-X264"                               : "H264",
		// "AVC-X264"                                               : "H264",

		"AVC-AVC1"                                               : "H264",
		"AVC"                                                    : "H264",

		"HEVC-HVC1-X265"                                         : "HEVC (x265)",
		"HEVC-V_MPEGH/ISO/HEVC-X265"                             : "HEVC (x265)",
		"HEVC-X265"                                              : "HEVC (x265)",
		// same as above without the extras, the one which comes later takes precedence
		// "HEVC-HVC1-X265"                                         : "HEVC",
		// "HEVC-V_MPEGH/ISO/HEVC-X265"                             : "HEVC",
		// "HEVC-X265"                                              : "HEVC",

		"HEVC-HVC1"                                              : "HEVC",
		"HEVC"                                                   : "HEVC",

		"HUFFYUV-HFYU"                                           : "HuffYUV",
		"HUFFYUV-V_MS/VFW/FOURCC / HFYU"                         : "HuffYUV",
		"HUFFYUV"                                                : "HuffYUV",
		...
		"MPEG-4 VISUAL-MP4V-20"                                  : "M4S2/MP4V",
		...
		"WMA-161-2"                                              : "WMA (v9.2)",
		"WMA-162--PRO"                                           : "WMA (v10 Pro)",
		"WMA-163--LOSSLESS"                                      : "WMA (v9.2 Lossless)",
		"WMA-A"                                                  : "WMA (v9 Voice)",
		"WMA"                                                    : "WMA",
		// same as above without the extras, the one which comes later takes precedence
		// "WMA-161-2"                                              : "WMA",
		// "WMA-162--PRO"                                           : "WMA",
		// "WMA-163--LOSSLESS"                                      : "WMA",
		// "WMA-A"                                                  : "WMA",
		// "WMA"                                                    : "WMA",

		"AC-3----DOLBY DIGITAL"                                  : "AC3 (Dolby Digital)",
		// same as above without the extras, the one which comes later takes precedence
		...
		"AMR-AMR---NARROW BAND"                                  : "AMR (Narrow Band)",
		"AMR-SAMR---NARROW BAND"                                 : "AMR (Narrow Band)",
		// same as above without the extras, the one which comes later takes precedence
		// "AMR-AMR---NARROW BAND"                                  : "AMR",
		// "AMR-SAMR---NARROW BAND"                                 : "AMR",
		"AMR"                                                    : "AMR",
		...
		"MLP FBA"                                                : "Atmos TrueHD",
		// same as above without the extras, the one which comes later takes precedence
		// "MLP FBA"                                                : "Atmos",
		"MUSEPACK SV8"                                           : "Musepack",

		// MPEG audio is major PITA like MPEG video!
		"MPEG AUDIO--1-LAYER 2"                                  : "MP2 (v1)",
		"MPEG AUDIO--2-LAYER 2"                                  : "MP2 (v2)",
		"MPEG AUDIO--2.5-LAYER 2"                                : "MP2 (v2.5)",
		"MPEG AUDIO-50-1-LAYER 2"                                : "MP2 (v1)",
		"MPEG AUDIO-50-2-LAYER 2"                                : "MP2 (v2)",
		"MPEG AUDIO-50-2.5-LAYER 2"                              : "MP2 (v2.5)",
		"MPEG AUDIO-55-1-LAYER 2"                                : "MP2 (v1)",
		"MPEG AUDIO-55-2-LAYER 2"                                : "MP2 (v2)",
		"MPEG AUDIO-55-2.5-LAYER 2"                              : "MP2 (v2.5)",
		"MPEG AUDIO-MP4A-69-1-LAYER 2"                           : "MP2 (v1)",
		"MPEG AUDIO-MP4A-69-2-LAYER 2"                           : "MP2 (v2)",
		"MPEG AUDIO-MP4A-69-2.5-LAYER 2"                         : "MP2 (v2.5)",
		"MPEG AUDIO-MP4A-6B-1-LAYER 2"                           : "MP2 (v1)",
		"MPEG AUDIO-MP4A-6B-2-LAYER 2"                           : "MP2 (v2)",
		"MPEG AUDIO-MP4A-6B-2.5-LAYER 2"                         : "MP2 (v2.5)",
		"MPEG AUDIO-A_MPEG/L3-1-LAYER 2"                         : "MP2 (v1)",
		"MPEG AUDIO-A_MPEG/L3-2-LAYER 2"                         : "MP2 (v2)",
		"MPEG AUDIO-A_MPEG/L3-2.5-LAYER 2"                       : "MP2 (v2.5)",
		"MPEG AUDIO--1-LAYER 3"                                  : "MP3 (v1)",
		"MPEG AUDIO--2-LAYER 3"                                  : "MP3 (v2)",
		"MPEG AUDIO--2.5-LAYER 3"                                : "MP3 (v2.5)",
		"MPEG AUDIO-50-1-LAYER 3"                                : "MP3 (v1)",
		"MPEG AUDIO-50-2-LAYER 3"                                : "MP3 (v2)",
		"MPEG AUDIO-50-2.5-LAYER 3"                              : "MP3 (v2.5)",
		"MPEG AUDIO-55-1-LAYER 3"                                : "MP3 (v1)",
		"MPEG AUDIO-55-2-LAYER 3"                                : "MP3 (v2)",
		"MPEG AUDIO-55-2.5-LAYER 3"                              : "MP3 (v2.5)",
		"MPEG AUDIO-MP4A-69-1-LAYER 3"                           : "MP3 (v1)",
		"MPEG AUDIO-MP4A-69-2-LAYER 3"                           : "MP3 (v2)",
		"MPEG AUDIO-MP4A-69-2.5-LAYER 3"                         : "MP3 (v2.5)",
		"MPEG AUDIO-MP4A-6B-1-LAYER 3"                           : "MP3 (v1)",
		"MPEG AUDIO-MP4A-6B-2-LAYER 3"                           : "MP3 (v2)",
		"MPEG AUDIO-MP4A-6B-2.5-LAYER 3"                         : "MP3 (v2.5)",
		"MPEG AUDIO-A_MPEG/L3-1-LAYER 3"                         : "MP3 (v1)",
		"MPEG AUDIO-A_MPEG/L3-2-LAYER 3"                         : "MP3 (v2)",
		"MPEG AUDIO-A_MPEG/L3-2.5-LAYER 3"                       : "MP3 (v2.5)",

		// same as above without the extras, the one which comes later takes precedence
		// "MPEG AUDIO--1-LAYER 2"                                  : "MP2",
		// "MPEG AUDIO--2-LAYER 2"                                  : "MP2",
		// "MPEG AUDIO--2.5-LAYER 2"                                : "MP2",
		// "MPEG AUDIO-50-1-LAYER 2"                                : "MP2",
		// "MPEG AUDIO-50-2-LAYER 2"                                : "MP2",
		// "MPEG AUDIO-50-2.5-LAYER 2"                              : "MP2",
		// "MPEG AUDIO-55-1-LAYER 2"                                : "MP2",
		// "MPEG AUDIO-55-2-LAYER 2"                                : "MP2",
		// "MPEG AUDIO-55-2.5-LAYER 2"                              : "MP2",
		// "MPEG AUDIO-MP4A-69-1-LAYER 2"                           : "MP2",
		// "MPEG AUDIO-MP4A-69-2-LAYER 2"                           : "MP2",
		// "MPEG AUDIO-MP4A-69-2.5-LAYER 2"                         : "MP2",
		// "MPEG AUDIO-MP4A-6B-1-LAYER 2"                           : "MP2",
		// "MPEG AUDIO-MP4A-6B-2-LAYER 2"                           : "MP2",
		// "MPEG AUDIO-MP4A-6B-2.5-LAYER 2"                         : "MP2",
		// "MPEG AUDIO-A_MPEG/L3-1-LAYER 2"                         : "MP2",
		// "MPEG AUDIO-A_MPEG/L3-2-LAYER 2"                         : "MP2",
		// "MPEG AUDIO-A_MPEG/L3-2.5-LAYER 2"                       : "MP2",
		// "MPEG AUDIO--1-LAYER 3"                                  : "MP3",
		// "MPEG AUDIO--2-LAYER 3"                                  : "MP3",
		// "MPEG AUDIO--2.5-LAYER 3"                                : "MP3",
		// "MPEG AUDIO-50-1-LAYER 3"                                : "MP3",
		// "MPEG AUDIO-50-2-LAYER 3"                                : "MP3",
		// "MPEG AUDIO-50-2.5-LAYER 3"                              : "MP3",
		// "MPEG AUDIO-55-1-LAYER 3"                                : "MP3",
		// "MPEG AUDIO-55-2-LAYER 3"                                : "MP3",
		// "MPEG AUDIO-55-2.5-LAYER 3"                              : "MP3",
		// "MPEG AUDIO-MP4A-69-1-LAYER 3"                           : "MP3",
		// "MPEG AUDIO-MP4A-69-2-LAYER 3"                           : "MP3",
		// "MPEG AUDIO-MP4A-69-2.5-LAYER 3"                         : "MP3",
		// "MPEG AUDIO-MP4A-6B-1-LAYER 3"                           : "MP3",
		// "MPEG AUDIO-MP4A-6B-2-LAYER 3"                           : "MP3",
		// "MPEG AUDIO-MP4A-6B-2.5-LAYER 3"                         : "MP3",
		// "MPEG AUDIO-A_MPEG/L3-1-LAYER 3"                         : "MP3",
		// "MPEG AUDIO-A_MPEG/L3-2-LAYER 3"                         : "MP3",
		// "MPEG AUDIO-A_MPEG/L3-2.5-LAYER 3"                       : "MP3",
		...
		"WAVE64-PCM-00000003-0000-0010-8000-00AA00389B71--FLOAT" : "PCM (Wave64, 32bit)",
		"WAVE64-PCM-3--FLOAT"                                    : "PCM (Wave64, 32bit)",
		"WAVE-PCM-00000003-0000-0010-8000-00AA00389B71--FLOAT"   : "PCM (Wave, 32bit)",
		"WAVE-PCM-3--FLOAT"                                      : "PCM (Wave, 32bit)",
		"WAVE64-PCM-1"                                           : "PCM (Wave64, 16/24bit)",
		"WAVE-PCM-1"                                             : "PCM (Wave, 16/24bit)",
		"WAVE64-PCM-00000001-0000-0010-8000-00AA00389B71"        : "PCM (Wave64, 16/24bit)",
		"WAVE-PCM-00000001-0000-0010-8000-00AA00389B71"          : "PCM (Wave, 16/24bit)",
		"WAVE64"                                                 : "PCM (Wave64)",
		"WAVE"                                                   : "PCM (Wave)",
		// same as above without the extras, the one which comes later takes precedence
		// "WAVE64-PCM-00000003-0000-0010-8000-00AA00389B71--FLOAT" : "PCM",
		// "WAVE64-PCM-3--FLOAT"                                    : "PCM",
		// "WAVE-PCM-00000003-0000-0010-8000-00AA00389B71--FLOAT"   : "PCM",
		// "WAVE-PCM-3--FLOAT"                                      : "PCM",
		// "WAVE64-PCM-1"                                           : "PCM",
		// "WAVE-PCM-1"                                             : "PCM",
		// "WAVE64-PCM-00000001-0000-0010-8000-00AA00389B71"        : "PCM",
		// "WAVE-PCM-00000001-0000-0010-8000-00AA00389B71"          : "PCM",
		// "WAVE64"                                                 : "PCM",
		// "WAVE"                                                   : "PCM",
	...
	for (var e = new Enumerator(scriptColData.columns); !e.atEnd(); e.moveNext()) {
        ...
        switch(key) {
			...
			case 'MExt_VideoCodec':
				...
				var lc = config.get('lookup_codecs');
				outstr = 	lc[_tmp0+'-'+_tmp1] ||
							lc[_tmp0+'-'+_tmp2] ||
							lc[_tmp0+'-'+_tmp3] ||
							lc[_tmp0+'-'+_tmp4] ||
							lc[_tmp0+'-'+_tmp5] ||
			...
			case 'MExt_CombinedDuration':
				...
				if (ldg) {
					for (var k in ldg) {
						if (item_props.audio_duration <= parseInt(k)) {
							scriptColData.columns(key).group = grpPrefix + 'Duration: ' + ldg[k]; break;
						}
					}
				} else {
...
// CLEAR CACHE
// called by user command, button, etc.
function OnME_ClearCache(scriptCmdData) {
...
function GetMediaInfoFor(oItem) {
	...
	var cmd 			= '"' + config.get('mediainfo_path') + '" --Output=JSON --LogFile="' + json_filepath + '" "' + oItem.realpath + '"';
	...
	*/
	var exit_code = util.shellGlobal.Run(cmd, 0, true); // 0: hidden, true: wait
	if (exit_code) {
...
function DumpCache(prefix, mode) {
	logger.error((prefix || '') + ' -- Cache dump @' + new Date().getTime().toString());
	switch (mode) {
		case 1: // names only
			for (var e = new Enumerator(util.sv.Get('cache')), item; !e.atEnd(); e.moveNext(), item = e.item()) {
				logger.error(prefix + ' - name: ' + item);
			}
			break;
		case 2: // count only
			logger.error(prefix + ' - Count: ' + util.sv.Get('cache').count);
			break;
		default: // everything
			for (var e = new Enumerator(util.sv.Get('cache')), item; !e.atEnd(); e.moveNext(), item = e.item()) {
				logger.error(prefix + ' - name->value: ' + item + ' -> ' + util.sv.Get('cache')(item));
			}
	}
}
